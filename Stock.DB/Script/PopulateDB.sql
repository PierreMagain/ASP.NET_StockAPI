...
VALUES 
    ...
    ('Pain', NULL, 'Pain de blé entier', '2024-06-30', 2.00, 0.06, 200, 0),
    ('Soccer Ball', 'Adidas', 'Official FIFA ball', NULL, 30.00, 0.21, 50, 0),
    ('TV', 'Sony', '55" Smart TV', '2026-01-01', 1200.00, 0.21, 30, 10),
    ('Jeans', 'Jack&Jones', 'Taille 32, couleur bleu', NULL, 50.00, 0.21, 80, 40),
    ('Baguette', NULL, 'French baguette', '2024-06-30', 1.50, 0.06, 150, 0),
    ('Basketball', 'Nike', 'Official NBA ball', NULL, 40.00, 0.21, 40, 0),
